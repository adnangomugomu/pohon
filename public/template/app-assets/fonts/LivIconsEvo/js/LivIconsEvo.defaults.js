...
function LivIconsEvoDefaults() {
    ...
    var defaultOptions = {
        ...
        pathToFolder: APP_URL + 'template/app-assets/fonts/LivIconsEvo/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
