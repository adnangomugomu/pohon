...
class RefKondisiController extends Controller
{
    public function index()
    {
        $data = [
            'title' => 'Referensi Kondisi Pohon',
            'header' => 'Referensi Kondisi Pohon',
            'breadcrumb' => ['Referensi', 'Kondisi Pohon', 'index']
        ];
    ...
    {
        $data = [];
        $html = view('admin.kondisi.form', $data)->render();
    ...
    {
        $row = Ref_kondisi::findOrFail($id);
        if ($row) {
            $data['row'] = $row;
            $html = view('admin.kondisi.detail', $data)->render();
    ...
    public function edit($id)
    {
        ...
        if ($row) {
            $data['row'] = $row;
            $html = view('admin.kondisi.formEdit', $data)->render();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($validator->fails()) {
                ...
                $data = Ref_kondisi::findOrFail($id);
                $data->nama = $request->nama;
                $data->save();
                DB::commit();
