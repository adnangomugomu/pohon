    ...
    <script>
        ...
        function load_table() {
            $('#table-data').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.ref_tajuk.getTable') }}',
                    type: 'GET',
                    dataType: 'JSON',
                },
                columns: [{
        ...
        function tambahData() {
            $.ajax({
                type: "GET",
                url: "{{ route('admin.ref_tajuk.create') }}",
                dataType: "JSON",
                data: {},
        ...
        function editData(id) {
            $.ajax({
                type: "GET",
                url: "{{ route('admin.ref_tajuk.edit', '') }}/" + id,
                dataType: "JSON",
                data: {},
                beforeSend: function(res) {
                    beforeLoading(res);
        ...
        function detailData(id) {
            $.ajax({
                type: "GET",
                url: "{{ route('admin.ref_tajuk.detail', '') }}/" + id,
                dataType: "JSON",
                data: {},
                beforeSend: function(res) {
                    beforeLoading(res);
        ...
        function hapusData(id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('admin.ref_tajuk.delete', '') }}/" + id,
                        dataType: "JSON",
                        beforeSend: function(res) {
                            beforeLoading(res);
                        },
