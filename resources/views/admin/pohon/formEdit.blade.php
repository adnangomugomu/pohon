        ...
        <div class="br-section-wrapper p-4">
            <form action="#" onsubmit="event.preventDefault();doSubmit(this);">
                <div class="form-group">
                    ...
                    <input type="text" value="{{ $row->nama_indo }}" name="nama_indo" class="form-control" placeholder="masukkan isian" required>
                </div>

                <div class="form-group">
                    <label>Nama Latin <small class="text-danger">*</small></label>
                    <input type="text" value="{{ $row->nama_latin }}" name="nama_latin" class="form-control" placeholder="masukkan isian" required>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $row->kode }}" name="kode" class="form-control" placeholder="masukkan isian" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="jenis_id" class="form-control form_select" data-placeholder="pilih jenis" required>
                                ...
                                @foreach ($jenis as $item)
                                    <option {{ $item->id == $row->jenis_id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $row->lokasi }}" name="lokasi" class="form-control" placeholder="ex: jl. merdeka 45">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ rupiah($row->tinggi, true) }}" name="tinggi" class="form-control rupiah" placeholder="masukkan isian" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Diameter Pohon (cm) <small class="text-danger">*</small></label>
                            <input type="text" value="{{ rupiah($row->diameter, true) }}" name="diameter" class="form-control rupiah" placeholder="masukkan isian" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="detail" rows="3" class="form-control" placeholder="detail pohon">{{ $row->detail }}</textarea>
                </div>
