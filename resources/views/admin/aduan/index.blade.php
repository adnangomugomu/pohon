    ...
    <script>
        ...
        function load_table() {
            $('#table-data').DataTable({
                ...
                ajax: {
                    url: '{{ route('admin.ref_aduan.getTable') }}',
                    type: 'GET',
                    dataType: 'JSON',
                },
                columns: [{
        ...
        function tambahData() {
            $.ajax({
                type: "GET",
                url: "{{ route('admin.ref_aduan.create') }}",
                dataType: "JSON",
                data: {},
        ...
        function editData(id) {
            $.ajax({
                type: "GET",
                url: "{{ route('admin.ref_aduan.edit', '') }}/" + id,
                dataType: "JSON",
                data: {},
                beforeSend: function(res) {
                    beforeLoading(res);
        ...
        function detailData(id) {
            $.ajax({
                type: "GET",
                url: "{{ route('admin.ref_aduan.detail', '') }}/" + id,
                dataType: "JSON",
                data: {},
                beforeSend: function(res) {
                    beforeLoading(res);
        ...
        function hapusData(id) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('admin.ref_aduan.delete', '') }}/" + id,
                        dataType: "JSON",
                        beforeSend: function(res) {
                            beforeLoading(res);
                        },
